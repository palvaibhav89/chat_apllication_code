package techknight.Vaibhav.view;
...
import techknight.Vaibhav.adapter.CircleTransform;
    ...
    private void setValues(){
        ...
        Glide.with(this).load( urlPhotoClick).asBitmap().override(640,640).fitCenter().into(new SimpleTarget<Bitmap>() {
            ...
            public void onLoadFailed(Exception e, Drawable errorDrawable) {
                Toast.makeText(FullScreenImageActivity.this,"Error loading image",Toast.LENGTH_LONG).show();
                progressDialog.dismiss();
            }
        });
    }
